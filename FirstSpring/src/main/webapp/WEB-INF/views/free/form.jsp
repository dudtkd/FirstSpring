					...
					<div class="card-body">
						<form method="post" action="/free/insert.do" id="freeForm" class="form-horizontal">
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<input name="freeTitle" type="text" id="freeTitle" class="form-control" value="${free.freeTitle }" placeholder="제목을 입력해주세요.">
								</div>
							...
							<div class="form-group row mt-4">
								...
								<div class="col-sm-10">
									<textarea name="freeContent" cols="50" rows="5" id="freeContent" class="form-control" placeholder="content"></textarea>
								</div>
